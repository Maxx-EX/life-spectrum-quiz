...
window.LSM_ITEMS = [
  ...
  // ============ 性别光谱域 · 工具效能（认知性别·工具性风格） ============
  { id: 121, dim: 'tools', text: '面对问题，我更倾向于先着手寻找解决方案，而不是先反复倾诉。', reverse: false },
  { id: 122, dim: 'tools', text: '我习惯把目标拆解成可执行的小步骤，一步步推进完成。', reverse: false },
  { id: 123, dim: 'tools', text: '做决定时，我更依赖事实和逻辑，而不是一时的心情。', reverse: false },
  { id: 124, dim: 'tools', text: '我享受用挑战或竞争来检验自己的能力。', reverse: false },
  { id: 125, dim: 'tools', text: '独立完成任务时，我感到更踏实、更有掌控感。', reverse: false },
  { id: 126, dim: 'tools', text: '有分歧时，我更关注"怎么解决"，而不是"谁对谁错"。', reverse: false },
  { id: 127, dim: 'tools', text: '我习惯直接表达自己的需求和立场。', reverse: false },
  { id: 128, dim: 'tools', text: '面对压力，我会先想行动方案，而不是先找人安慰。', reverse: false },
  { id: 129, dim: 'tools', text: '遇到困难时，我常常先向他人倾诉寻求支持，而不是自己先动手解决。', reverse: true },
  { id: 130, dim: 'tools', text: '我重视效率和结果，不喜欢无意义的拖延。', reverse: false },

  // ============ 性别光谱域 · 表达温暖（认知性别·表达性风格） ============
  { id: 131, dim: 'expr', text: '朋友难过时，我会自然地用陪伴和言语去安慰对方。', reverse: false },
  { id: 132, dim: 'expr', text: '我乐于主动表达对身边人的欣赏与喜爱。', reverse: false },
  { id: 133, dim: 'expr', text: '我能坦然承认自己的情绪，也愿意向信任的人求助。', reverse: false },
  { id: 134, dim: 'expr', text: '比起"把事情做对"，我更在意关系是否融洽。', reverse: false },
  { id: 135, dim: 'expr', text: '我擅长用细腻的语言描述自己的感受。', reverse: false },
  { id: 136, dim: 'expr', text: '我习惯先照顾他人的情绪，再安排自己的节奏。', reverse: false },
  { id: 137, dim: 'expr', text: '我愿意为维系亲近关系而调整自己的一些需求。', reverse: false },
  { id: 138, dim: 'expr', text: '我更喜欢以倾听和陪伴的方式支持他人，而不是急着给建议。', reverse: false },
  { id: 139, dim: 'expr', text: '在亲近的人面前，我能够自然地示弱或表达需要。', reverse: false },
  { id: 140, dim: 'expr', text: '我不太愿意在别人面前表露自己的情绪与感受。', reverse: true }
];

// 自检：确认共 140 题，且每维 10 题
(function selfCheck() {
  ...
  console.log('[LSM-140 自检] 题目总数:', count, '| 各维度题数:', JSON.stringify(dimMap));
})();

// ============================================================
// 处方药用药安全自检（面向 11–18 岁 · 原创题目）
// 目的：帮助识别与预防未成年人私自服用处方药
// 本模块独立于 12 维光谱计分，仅作安全提示
// ============================================================
window.LSM_SAFETY = {
  title: '处方药用药安全自检',
  intro: '处方药必须凭医生处方、在医生或家长指导下使用，绝不能私自服用或分享。请按真实情况选择。',
  guidance: {
    high: '你的用药安全意识很到位。请继续保持：任何药物都先问医生或家长，不私自加量、不停药、不分享。',
    mid:  '你基本了解用药安全，但还有一些需要注意的地方。遇到不确定的药，请先问医生或家长，不要自己乱吃。',
    low:  '请重视用药安全：处方药必须在医生或家长指导下服用，绝不私自服用或分享他人药物。如果你正在未经医嘱服用任何处方药，请立即停止，并告诉家长、老师或医生。',
    always: '重要提醒：处方药不是零食，擅自服用可能伤害身体。拿不准的药，先问可信的大人。'
  },
  items: [
    { id: 's1', text: '我只有在医生或家长（监护人）的指导下，才会服用处方药。' },
    { id: 's2', text: '我从不会在没有医生同意的情况下，服用别人的处方药。' },
    { id: 's3', text: '我知道处方药不能自己加大剂量，也不能随意停药。' },
    { id: 's4', text: '如果别人劝我偷偷吃药，我会拒绝，并告诉可信的大人。' },
    { id: 's5', text: '我吃任何药之前，都会先看药名、剂量和服用方法。' },
    { id: 's6', text: '我了解处方药不能随便分享给别人，也不该和酒精饮料混着用。' }
  ]
};
...
(function selfCheck() {
  ...
  window.LSM_ITEMS.forEach(function (it) { dimMap[it.dim] = (dimMap[it.dim] || 0) + 1; });
  console.log('[LSM-140 自检] 题目总数:', count, '| 各维度题数:', JSON.stringify(dimMap));
  if (window.LSM_SAFETY) console.log('[用药安全自检] 题目数:', window.LSM_SAFETY.items.length);
})();
